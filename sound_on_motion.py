...
# Variables
show_debug = False
contoursize = 3000 # motion sensitivity. higher is less sensitive. default: 10000
sensitivity = 55 # binary threshold. higher is less sensitive. default: 30
deepfactor = 12
interval = 5.0
blursize = 17
...
while True:
	...
	cv2.imshow("The Amazon Watchdog ", differ_frame)
